...
import com.kafka.event.BankTransaction;
import com.kafka.event.Event;
...
public class DataGenerator {
	...
	private Event eventBuilder (BankTransaction t, int i) throws JsonProcessingException {
		...
		return new Event("transaction", t.getType() == "Credit" ? "AmountCredited" : "AmountDebited", t.getTransactionTime(), t);
	}
}
